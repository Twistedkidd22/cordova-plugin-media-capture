...
//    private static final int CAPTURE_INVALID_ARGUMENT = 2;
    ...
    private static boolean ANDROID_13 = false;
...
//    }
    ...
    private boolean isMissingCameraPermissions(Request req, String mediaPermission) {
        ...
        if (ANDROID_13 == true && mediaPermission != null) {
    ...
    public void onRequestPermissionResult(int requestCode, String[] permissions,
        ...
        if (req != null) {
            ...
            if (success) {
                ...
                pendingRequests.resolveWithFailure(req, createErrorObject(CAPTURE_PERMISSION_DENIED, "cpmc -- Permission denied."));
            }
        }
    }
